                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h5 class="mt-2 mb-1 ff-secondary fw-semibold">
                                <span class="counter-value" data-target="{{ $summary['Pending'] ?? 0 }}">{{ $summary['Pending'] ?? 0 }}</span>
                            </h5>
                ...
                <div class="card-body py-2 px-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h5 class="mt-2 mb-1 ff-secondary fw-semibold">
                                <span class="counter-value" data-target="{{ $summary['In Progress'] ?? 0 }}">{{ $summary['In Progress'] ?? 0 }}</span>
                            </h5>
                            <p class="mb-0 text-muted small">
                ...
                <div class="card-body py-2 px-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h5 class="mt-2 mb-1 ff-secondary fw-semibold">
                                <span class="counter-value" data-target="{{ $summary['Completed'] ?? 0 }}">{{ $summary['Completed'] ?? 0 }}</span>
                            </h5>
                            <p class="mb-0 text-muted small">
                ...
                <div class="card-body py-2 px-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h5 class="mt-2 mb-1 ff-secondary fw-semibold">
                                <span class="counter-value" data-target="{{ $summary['Cancelled'] ?? 0 }}">{{ $summary['Cancelled'] ?? 0 }}</span>
                            </h5>
                            <p class="mb-0 text-muted small">
