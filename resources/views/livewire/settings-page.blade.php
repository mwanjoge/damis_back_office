                        ...
                        <div class="tab-pane active" id="countries" role="tabpanel">
                            <div class="justify-content-end text-end align-content-start pb-4">
                                <button type="button" class="btn btn-primary " data-bs-toggle="modal"
                                    data-bs-target=".country-modal">New Country</button>
                            </div>
                                                            ...
                                                            <form>
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <select class="form-select" aria-label="Default select example">
                                                                        <option selected value="{{ $country['embassy_name'] }}">{{ $country['embassy_name'] }}</option>
                                                        ...
                                                        <div class="modal-body">
                                                            <form>
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <select class="form-select" aria-label="Default select example">
                                                                        <option selected value="{{ $service['service_provider'] }}">{{ $service['service_provider'] }}</option>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="live-preview">
                        <div>
                            <div class="modal fade country-modal" tabindex="-1" role="dialog"
                                            ...
                                            <div class="mt-4 text-center">
                                                ...
                                                <form action="">
                                                    <div class="col-md-12 justify-content-center">
                                                        ...
                                                        <select wire:model="embassies" class="js-example-basic-multiple">
