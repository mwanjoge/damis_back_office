        ...
        <div class="card">
            <div class="card-header">
                <div class=" d-flex justify-content-between align-items-center container-fluid">
                    ...
                    <a href="javascript:void(0)" wire:click="addInput" id="add-request-item"
                            ...
                            <div class="card-body">
                                <div class="row g-3 align-items-center">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <select wire:model.live="inputs.{{ $key }}.service_id"
                                            class="form-select" name="request_items[{{ $key }}][service_id]"
                                            required>
