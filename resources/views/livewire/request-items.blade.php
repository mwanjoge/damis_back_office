                    ...
                    <div class="card-body">
                        <div class="row g-3 align-items-center">
                            <div class="col-md-2">
                                ...
                                <select wire:model.live="inputs.{{ $key }}.service_provider_id" wire:change="getServices({{ $key }})" class="form-select" name="request_items[{{ $key }}][service_provider_id]" required>
                            ...
                            <div class="col-md-2">
                                ...
                                <select wire:model.live="inputs.{{ $key }}.service_id" class="form-select" name="request_items[{{ $key }}][service_id]" required>
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="text" wire:model="inputs.{{ $key }}.certificate_index_number" name="request_items[{{ $key }}][certificate_index_number]" class="form-control">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="file" wire:model="inputs.{{ $key }}.attachment" name="request_items[{{ $key }}][attachment]" class="form-control" placeholder="Attachment">
                                @error("inputs.$key.attachment")
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-auto ms-auto">
                                <button type="button" wire:click="removeInput({{ $key }})" class="btn btn-danger btn-icon" title="Remove item">
