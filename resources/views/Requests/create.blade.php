    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <div id="request-items-list">
                <!-- Template row (hidden) -->
                <div class="request-item-row row g-2 mb-2 align-items-end d-none" id="request-item-template">
                    <div class="col">
                        <label class="form-label form-label-sm">Service Provider</label>
                        <select name="service_provider_id[]" class="form-select form-select-sm" required>
                    ...
                    <div class="col">
                        ...
                        <input type="text" name="certificate_holder_name[]" class="form-control form-control-sm" required>
                    </div>
                    <div class="col">
                        <label class="form-label form-label-sm">Index Number</label>
                        <input type="text" name="certificate_index_number[]" class="form-control form-control-sm">
                    </div>
                    <div class="col">
                        <label class="form-label form-label-sm">Attachment</label>
                        <div class="input-group input-group-sm">
                            <input type="file" name="attachment[]" class="form-control form-control-sm" placeholder="Attachment">
                        </div>
                    </div>
                    <div class="col-auto">
...
<script>
function myFunction() {
  const node = document.getElementById("request-item-row row g-2 mb-2 align-items-end d-none ");
  const clone = node.cloneNode(true);
  document.getElementById("request-items-list").appendChild(clone);
}
</script>
@endsection
