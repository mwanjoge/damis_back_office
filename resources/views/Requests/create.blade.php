            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select id="member_id" name="member_id" data-choices class="form-select @error('member_id') is-invalid @enderror" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <select id="countrySelect" name="country_id" data-choices class="form-select @error('country_id') is-invalid @enderror" required>
