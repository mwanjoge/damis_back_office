                ...
                <div class="col-md-8 col-lg-5 col-xl-4">
                    <header class="header">
                        <div class="title-area">
                            <img src="<?php echo e(asset('images/emblem.png')); ?>" alt="Logo"> <!-- Replace with your actual logo -->
...
unset($__errorArgs, $__bag); ?>"
                                            value="<?php echo e(old('email', 'admin@gmail.com')); ?>" id="username" name="email"
...
<?php echo $__env->make('layouts.master-without-nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/administrator/Herd/damis_back_office/resources/views/auth/login.blade.php ENDPATH**/ ?>