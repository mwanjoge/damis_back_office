<header id="page-topbar bg-white" style="position: fixed; width: 100%; z-index: 2;" class="container-fluid">
    <div class="layout-width bg-white">
        <div class="navbar-header">
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="index" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="<?php echo e(URL::asset('images/emblem.png')); ?>" alt="" height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="<?php echo e(URL::asset('images/emblem.png')); ?>" alt="" height="45">
                        </span>
                    </a>
                    ...
                    <a href="index" class="logo logo-light">
                        ...
                        <span class="logo-lg">
                            <img src="<?php echo e(URL::asset('images/emblem.png')); ?>" alt="" height="17">
                        </span>
                    </a>
                </div>
            ...
            <div class="d-flex flex-column justify-content-center align-items-center w-100 text-white">
                ...
                <h4 class="mb-0" style="font-size: 0.9rem; font-weight: 400;">Ministry of Foreign Affairs and East
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1">
                                                <a href="#!" class="stretched-link">
                                                    <h6 class="mt-0 mb-2 lh-base">A new request waiting approval
                                                    </h6>
                                                </a>
                        ...
                        <span class="d-flex align-items-center">
                            <?php if(auth()->guard()->check()): ?>
                                <img class="rounded-circle header-profile-user"
                                    src="<?php echo e(URL::asset('build/images/users/user-avatar.jpeg')); ?> " alt="Header Avatar">
...
<?php /**PATH D:\PROJECTS\damis_back_office\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>