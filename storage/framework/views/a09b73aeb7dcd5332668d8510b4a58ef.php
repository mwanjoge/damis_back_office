                    ...
                    <div class="card-body">
                        <div class="row g-3 align-items-center">
                            <div class="col-md-2">
                                ...
                                <select wire:model.live="inputs.<?php echo e($key); ?>.service_provider_id" wire:change="getServices(<?php echo e($key); ?>)" class="form-select" name="request_items[<?php echo e($key); ?>][service_provider_id]" required>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div class="col-md-2">
                                ...
                                <select wire:model.live="inputs.<?php echo e($key); ?>.service_id" class="form-select" name="request_items[<?php echo e($key); ?>][service_id]" required>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" wire:model="inputs.<?php echo e($key); ?>.price" name="request_items[<?php echo e($key); ?>][price]" class="form-control" step="0.01" readonly required>
                                </div>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="text" wire:model="inputs.<?php echo e($key); ?>.certificate_holder_name" name="request_items[<?php echo e($key); ?>][certificate_holder_name]" class="form-control" required>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="text" wire:model="inputs.<?php echo e($key); ?>.certificate_index_number" name="request_items[<?php echo e($key); ?>][certificate_index_number]" class="form-control">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="file" wire:model="inputs.<?php echo e($key); ?>.attachment" name="request_items[<?php echo e($key); ?>][attachment]" class="form-control" placeholder="Attachment">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div class="col-auto ms-auto">
                                <button type="button" wire:click="removeInput(<?php echo e($key); ?>)" class="btn btn-danger btn-icon" title="Remove item">
