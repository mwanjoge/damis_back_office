            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="index" class="logo logo-dark">
                        ...
                        <span class="logo-lg">
                            <img src="<?php echo e(URL::asset('build/images/logo.png')); ?>" alt="" height="45">
                        </span>
                    </a>
                    ...
                    <a href="index" class="logo logo-light">
                        ...
                        <span class="logo-lg">
                            <img src="<?php echo e(URL::asset('build/images/logo.png')); ?>" alt="" height="17">
                        </span>
                    </a>
                </div>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            <?php if(auth()->guard()->check()): ?>
                                <img class="rounded-circle header-profile-user" src="<?php echo e(URL::asset('build/images/users/user-avatar.jpeg')); ?> " alt="Header Avatar">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="<?php echo e(route('user-profile')); ?>"><i class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Profile</span></a>
...
<?php /**PATH /Users/administrator/Herd/damis_back_office/resources/views/layouts/topbar.blade.php ENDPATH**/ ?>